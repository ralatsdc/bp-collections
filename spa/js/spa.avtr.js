...
spa.avtr = (function () {
    ...
    onSetchatee = function (event, arg_map) {
        ...
        // Use this to highlight avatar of uer in nav area
    ...
    /* configModule
     *
     * Purpose: Configure the module prior to initialization, values
     *   we do not expect to change during a user session.
     *
     * Arguments:
     *   input_map - map used to update configuration
     *
     * Action:
     ...
     *         missing arguments
     *
     * Example: spa.avtr.configModule({slider_open_em: 18});
     */
    ...
    /* initModule
     *
     * Purpose: Directs avtr to offer its capability to the user
     *
     * Arguments:
     ...
     *
     * Action:
     *   Provides avatar interface for chat users
     *
     * Returns:
     *   true - on success
     *   false - on failure
     ...
     * Throws: none
     *
     * Example: spa.avtr.initModule($('#div_id'));
     */
